...
from models import EndUserRouteHalResponse, ErrorResponse, ValidationErrorsResponse
...
@app.get(
    ...
    tags=['account_extension_management'],
    security=[
        HTTPBearer(name="None"),
    ],
)
def extension_ctrl_get_account_extensions(
    account_id: str,
...
def extension_ctrl_get_account_extension_by_i_d(
    account_id: str, extension_number: float = ...
):
    """
